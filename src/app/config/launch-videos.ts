/**
 * Background video URL per launch area slug.
 * Replace with your Luma-generated .mp4 URLs once hosted.
 */
export const LAUNCH_VIDEOS: Record<string, string> = {
  math: "/videos/math.mp4",
